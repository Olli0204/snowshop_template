            ...
            <footer id="footer" {if $newsletterActive}class="newsletter-active"{/if}>
                    ...
                    {if $newsletterActive}
                        {block name='layout-footer-newsletter'}
                            {row class="newsletter-footer"}
                                ...
                                {/col}
                            {/row}
                            {* Neue klasse für das hr-Element vergeben *} 
                            <hr class="bottom-hr-new">
                        {/block}
                    {/if}
                ...
                {block name='layout-footer-copyright'}
                    <div id="copyright">
                        ...
                        {/container}
                        {if !$isMobile}
                            <div class="bottom-bar-big-box"{*id="copyright"*}>
                            {* Footer- Informationen über Zahlungsarten und Versandarten *}
                            {block name='Bottom-Bar-Payment-Shipment-Secure'}
                                            <div id="information-bottom-bar">
                                                <div class="bottom-bar">
                                                    <div class="payment-bottom">
                                                        <div class="text-bottom-bar" style="text-align: center; font-size: 12px;">
                                                            {if $lang eq "eng"}
                                                            <p>Pay<br>with</p>
                                                            {else}
                                                            <p>Bezahlen<br>mit</p>
                                                        ...
                                                        <div class="header-payment-logo" >
                                                            <img class="visible-img alignment" height="30px" src="{$shopURL}/{$currentTemplateDir}mediafiles/special_logos/paypal_colour_bearbeitet.png" />
                                                        </div>
                                                        <div class="header-payment-logo" >
                                                            <img class="visible-img alignment" height="30px" src="{$shopURL}/{$currentTemplateDir}mediafiles/special_logos/amazonpay-logo-colour.png" />
                                                        </div>
                                                        <div class="header-payment-logo" >
                                                            <img class="visible-img alignment" height="30px" src="{$shopURL}/{$currentTemplateDir}mediafiles/special_logos/apple-pay.png" />
                                                        </div>
                                                        <div class="header-payment-logo" >
                                                            <img class="visible-img alignment" height="30px" src="{$shopURL}/{$currentTemplateDir}mediafiles/special_logos/google-pay.png" />
                                                        </div>
                                                        <div class="text-bottom-bar">
                                                            <p style="padding-left: 15px; padding-right: 15px; margin: auto;">Vorkasse</p>
                                                        </div>                                              
                                                    </div>
                                                    <div class="shipment-bottom">
                                                        <div class="text-bottom-bar" style="text-align: center; font-size: 12px;">
                                                            {if $lang eq "eng"}
                                                            <p>Shipment<br>with</p>
                                                            {else}
                                                            <p>Versand<br>mit</p>
                                                            {/if}
                                                        </div>
                                                        <div class="header-payment-logo" >
                                                            <img class="visible-img alignment" height="35px" src="{$shopURL}/{$currentTemplateDir}mediafiles/special_logos/dpd_colour.png" />
                                                        </div>
                                                        <div class="header-payment-logo" >
                                                            <img class="visible-img alignment" height="35px" src="{$shopURL}/{$currentTemplateDir}mediafiles/special_logos/dhl_colour.png" />
                                                        </div>
                                                    </div>
                                                    <div class="secure-bottom">
                                                        <div class="text-bottom-bar" style="text-align: center; font-size: 12px;">
                                                            ...
                                                            {else}
                                                            <p>Sicher<br>einkaufen</p>
                                                            {/if}
                                                        </div>
                                                        <div class="header-payment-logo" >
                                                            <img class="visible-img alignment" height="35px" src="{$shopURL}/{$currentTemplateDir}mediafiles/special_logos/ssl_colour.png" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
